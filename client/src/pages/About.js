  ...
  <div style={styles}>
    ...
    >
      <div style={{height: 300}}>
        <div style={insideStyles}>
          ...
          <p class="welcome welcome2">Where families meet to share recipes, photos and memories</p>
        </div>
      </div>
    ...
    <Parallax 
      ...
      <ul style={{ padding: 20, position: 'absolute', top: '70%', left: '50%', transform: 'translate(-50%,-50%)' }}>
        ...
        <li>
          <a target="_blank" href="https://www.urbandictionary.com/define.php?term=Noms" className="border btn">What the heck does NOM mean?</a>
        </li>
      </ul>
    </Parallax>
